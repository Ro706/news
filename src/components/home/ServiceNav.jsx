...
const SERVICES = [
    ...
    },
    {
        ...
        title: "Our Services",
        description:
            "Explore our comprehensive suite of services designed to elevate your brand and engage your audience effectively.",
        cards: [
        ],
    },
];
...
function ServiceNav() {
    ...
    const handleServiceClick = (idx) => {
        if (SERVICES[idx].id === "services") {
            navigate("/services");
        } else {
            navigate(`/services/${SERVICES[idx].id}`);
        }
    };
    ...
    const handleTagClick = (serviceId) => {
        navigate(`/services/${serviceId}`);
    };

    const currentService = !isMobile && activeService !== null ? SERVICES[activeService] : null;
    ...
    return (
        ...
        >
            <section
                className="service-section-home"
                ref={sectionRef}
            ...
            >
                ...
                >
                    ...
                    >
                            ...
                            {SERVICES.map((service, idx) => {
                                ...
                                return (
                                    <motion.li
                                        ...
                                        whileHover={activeService === null ? { scale: 1.05 } : {}}
                        ...
                        >
                            We build and protect your brand’s reputation with smart media
                            outreach, thought leadership, and consistent messaging.
                        </motion.p>
                    </motion.div>
                    <motion.div
                        className="right"
                                    ...
                                    <div className="service-tags">
                                        {currentService.cards.map((card, idx) => (
                                            <motion.a
                                                ...
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                    handleTagClick(currentService.id);
                                                }}
                                            >
                                                {card.label}
                                            </motion.a>
